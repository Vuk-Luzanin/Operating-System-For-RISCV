...
extern const uint64 CONSOLE_TX_DATA;            //to send
extern const uint64 CONSOLE_RX_DATA;            //to read

static const uint64 CONSOLE_IRQ = 10;
static const uint64 CONSOLE_TX_STATUS_BIT = 1 << 5;     //we can send on console
static const uint64 CONSOLE_RX_STATUS_BIT = 1;          //we can take from console
